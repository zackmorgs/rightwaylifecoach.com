...
<main>
    <header class="hero">
        <div class="container">
            <div class="text-center">
                ...
                <h2>About Robin Morgenthaler</h2>
            </div>
        </div>
    </header>
    <section>
        <div class="container">
            ...
            <p>
                ...
                discerning, and grounded in Scripture. She creates a thoughtful space where women can reflect honestly,
                listen for God’s leading, and take intentional steps forward—without being rushed, fixed, or told what
                to do.
            </p>
            <p>
    ...
    <section>
        <div class="container">
            ...
            <p>
                I coach because I have seen, again and again, what can happen when a woman is given space to be heard,
                to reflect honestly, and to listen for God’s voice in the midst of a full and demanding life.
            </p>
            <p>
                For decades, I have sat with women as they navigated uncertainty, transition, and calling—often while
                carrying significant responsibility for others. Many of these women were strong, capable, and faithful,
                yet unsure how to move forward with clarity and peace. What they needed was not advice or fixing, but a
                trusted partner who would walk alongside them, ask thoughtful questions, and help them notice what God
                might already be stirring.
            </p>
            <p>
                Christian life coaching allows me to do exactly that.
            </p>
            <p>
                Coaching creates a focused, prayerful space to slow down, discern, and act. It honors both faith and
                responsibility. It respects your agency while inviting attentiveness to the Holy Spirit. Over time, I
                have seen women gain confidence, make wise decisions, and step more fully into the lives God has
                entrusted to them.
            </p>
            <p>
                I coach because I believe God is still calling, still guiding, and still at work—and because no one
                should have to listen for that call alone.
            </p>
